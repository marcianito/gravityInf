...
run_model_inversion_combinedProcPP_macrofree = function(
            dtheta1_min,
            dtheta1_max,
            dtheta2_min,
            dtheta2_max,
  ...
  # DO use lateral flow module
      ...
      bypass = {
        # combine input parameters
        param_bounds = data.frame(minimum = c(dtheta1_min, dtheta2_min, dtheta3_min, dtheta4_min, dtheta5_min, dtheta6_min, pdepth_min, pdepth2_min, latflow_fac_min),
                              maximum = c(dtheta1_max, dtheta2_max, dtheta3_max, dtheta4_max, dtheta5_max, dtheta6_max, pdepth_max, pdepth2_max, latflow_fac_max))
        # combine start parameter values
        param_startvalue = c(dtheta1_start, dtheta2_start, dtheta3_start, dtheta4_start, dtheta5_start, dtheta6_start, pdepth_start, pdepth2_start, latflow_fac_start)
        # column names for model output
        model_info_colnames = c("dtheta1", "dtheta2", "dtheta3", "dtheta4", "dtheta5", "dtheta6", "pdepth", "pdepth2", "latflow")
        # set name of model to use
        model = "inf_model_3d_combinedProcLatFlowPP_macrofree"
             },
      perched = {
        # combine input parameters
        param_bounds = data.frame(minimum = c(dtheta1_min, dtheta2_min, dtheta3_min, dtheta4_min, dtheta5_min, dtheta6_min, pdepth_min, pdepth2_min, latflow_fac_min),
      ...
      wfa = {
        # combine input parameters
        param_bounds = data.frame(minimum = c(dtheta1_min, dtheta2_min, dtheta3_min, dtheta4_min, dtheta5_min, dtheta6_min, pdepth_min, latflow_fac_min),
                              maximum = c(dtheta1_max, dtheta2_max, dtheta3_max, dtheta4_max, dtheta5_max, dtheta6_max, pdepth_max, latflow_fac_max))
        # combine start parameter values
        param_startvalue = c(dtheta1_start, dtheta2_start, dtheta3_start, dtheta4_start, dtheta5_start, dtheta6_start, pdepth_start, latflow_fac_start)
        # column names for model output
        model_info_colnames = c("dtheta1", "dtheta2", "dtheta3", "dtheta4", "dtheta5", "dtheta6", "pdepth", "pdepth2", "latflow")
        # set name of model to use
        model = "inf_model_3d_combinedProcLatFlow_wfaPP_macrofree"
      }
      )
  }
