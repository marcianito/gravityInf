...
param_vec = c(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21, param_22, param_23, param_24, param_25, param_26, param_27, param_28, param_29, param_30, param_31, param_32, param_33, param_34, param_35, param_36, param_37, param_38, param_39, param_40, param_41, param_42, param_43, param_44, param_45, param_46, param_47, param_48, param_49, param_50, param_51, param_52)
...
dtheta8 = param_vec[8]
dtheta9 = param_vec[9]
dtheta10 = param_vec[10]
dtheta11 = param_vec[11]
dtheta12 = param_vec[12]
dtheta13 = param_vec[13]
dtheta14 = param_vec[14]
dtheta15 = param_vec[15]
dtheta16 = param_vec[16]
dtheta17 = param_vec[17]
dtheta18 = param_vec[18]
dtheta19 = param_vec[19]
dtheta20 = param_vec[20]
dtheta21 = param_vec[21]
dtheta22 = param_vec[22]
dtheta23 = param_vec[23]
dtheta24 = param_vec[24]
dtheta25 = param_vec[25]
dtheta26 = param_vec[26]
dtheta27 = param_vec[27]
dtheta28 = param_vec[28]
dtheta29 = param_vec[29]
dtheta30 = param_vec[30]
dtheta31 = param_vec[31]
dtheta32 = param_vec[32]
dtheta33 = param_vec[33]
dtheta34 = param_vec[34]
dtheta35 = param_vec[35]
dtheta36 = param_vec[36]
dtheta37 = param_vec[37]
dtheta38 = param_vec[38]
dtheta39 = param_vec[39]
dtheta40 = param_vec[40]
dtheta41 = param_vec[41]
dtheta42 = param_vec[42]
dtheta43 = param_vec[43]
dtheta44 = param_vec[44]
dtheta45 = param_vec[45]
dtheta46 = param_vec[46]
dtheta47 = param_vec[47]
dtheta48 = param_vec[48]
dtheta49 = param_vec[49]
dtheta50 = param_vec[50]
pdepth = round(param_vec[51],1)
pdepth2 = round(pdepth - 0.1,1)
# lateral flow factor (seperate into lateral and vertical flow)
latflow_fac = param_vec[52]
...
if(pdepth2 >= pdepth){
  ...
  message(paste0("Problem with vertical layer distribution in paramterset: ", n_param))
  kge_fit = 1
  return(kge_fit) 
...
pdepth2_layer = which(zlayers == pdepth2)
# determine vertical start
# other_layer = which(zlayers == otherdepth)
layers_between_processes = pdepth2_layer - pdepth_layer
...
#               )
# }
## macropores AND by-pass flow
# if(use_scenario == "macropores" & use_scenario2 == "bypass"){
# layer_params = data.frame(Depth = zlayers,
...
#                          #
#                          infProcess = c(rep("macro", pdepth_layer), rep("none", layers_between_processes), rep("other",(length(zlayers) - pdepth2_layer))),
#                          nlayer = c(rep(1, pdepth_layer), rep(10001, layers_between_processes), seq(1, length.out=(length(zlayers) - pdepth2_layer))),
#                          dtheta = c(rep(dtheta, pdepth_layer), rep(0, layers_between_processes), rep(dtheta2, (length(zlayers) - pdepth2_layer)))
#               )
# }
if(use_scenario == "macropores" & use_scenario2 == "wfa"){
layer_params = data.frame(Depth = zlayers,
                         infProcess = c(rep("macro", pdepth_layer), rep("other",(length(zlayers) - pdepth_layer))),
                         nlayer = c(rep(1, pdepth_layer), seq(1, length.out=(length(zlayers) - pdepth_layer))),
                         # dtheta = c(rep(dtheta, pdepth_layer), rep(dtheta2, (length(zlayers) - pdepth_layer)))
                         dtheta = c(dtheta1, dtheta2, dtheta3, dtheta4, dtheta5, dtheta6, dtheta7, dtheta8, dtheta9, dtheta10, dtheta11, dtheta12, dtheta13, dtheta14, dtheta15, dtheta16, dtheta17, dtheta18, dtheta19, dtheta20, dtheta21, dtheta22, dtheta23, dtheta24, dtheta25, dtheta26, dtheta27, dtheta28, dtheta29, dtheta30, dtheta31, dtheta32, dtheta33, dtheta34, dtheta35, dtheta36, dtheta37, dtheta38, dtheta39, dtheta40, dtheta41, dtheta42, dtheta43, dtheta44, dtheta45, dtheta46, dtheta47, dtheta48, dtheta49, dtheta50)
              )
}
## macropores
