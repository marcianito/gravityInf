...
inf_model_3d_combinedProcLatFlow_prefflowPP = function(param_1, param_2, param_3, param_4, param_5){
...
message("deleting raw output files")
systemcall_del = paste0("rm ", output_dir, "model_output/raw/tsx_", n_param, "*.txt")
print(paste0("delete statement: ", systemcall_del))
message(paste0("delete statement: ", systemcall_del))
