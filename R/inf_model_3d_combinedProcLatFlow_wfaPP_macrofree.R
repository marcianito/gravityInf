...
inf_model_3d_combinedProcLatFlow_wfaPP_macrofree = function(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8){
...
param_vec = c(param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8)
...
layer_params = data.frame(Depth = zlayers,
                         ...
                         dtheta = c(dtheta1, dtheta2, dtheta3, dtheta4, dtheta5, rep(dtheta6, 46))
              )
}
## macropores
